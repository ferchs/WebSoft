 ...
 * @author ferchs
 */
public class ControlEditarEstudiantePanel {
    
    
    public boolean editarEstudiante(String idEstudiante,String tipoDocumentoEstudiante,String primerNombreEstudiante,
        ...
        Personas estudiante=p.editarPersona(idEstudiante, primerNombreEstudiante, segundoNombreEstudiante, primerApellidoEstudiante,segundoApellidoEstudiante,di, ic, im);  
        DocumentoIdentidad di2= new DocumentoIdentidad();
        di2.setPersonasId(idFamiliar);
        di2.setTipo(tipoDocumentoFamiliar);
        
        Personas familiar=p.editarPersona(idFamiliar, primerNombreFamiliar, segundoNombreFamiliar, primerApellidoFamiliar, segundoApellidoFamiliar, di2, null, null);
        
        Roles roles= new Roles();
        Rol rol=roles.crearRol(parentescoFamiliar);
        Responsable responsable= new Responsable();
        responsable.editarResponsable(rol, familiar, estudiante, profesionFamiliar);
        }
        catch(Exception e){
            e.printStackTrace();
            editado=false;
