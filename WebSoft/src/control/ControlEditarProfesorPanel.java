 ...
 * @author ferchs
 */
public class ControlEditarProfesorPanel {
    
    public boolean editarProfesor(String idProfesor,String tipoDocumentoProfesor,String primerNombreProfesor,
        ...
        Personas persona=p.editarPersona(idProfesor, primerNombreProfesor, segundoNombreProfesor, primerApellidoProfesor, segundoApellidoProfesor, di, ic, im);
        Profesor profe = new Profesor();
        profe.editarProfesor(persona,tituloProfesor,institucionProfesor);
        }
        catch(Exception e){
            e.printStackTrace();
            agregado=false;
