 ...
 * @author ferchs
 */
public class BuscarSalonPanel extends javax.swing.JPanel  {

    /**
     * Creates new form AgregarEstudiantePanel
     */
    
    protected AdministrarSalonesPanel administrarSalonesPanel;
    
    public BuscarSalonPanel(AdministrarSalonesPanel administrarSalonesPanel) {
        initComponents();
        controlAdministrarSalones= new ControlAdministrarRecursos();
        jScrollPane1= new JScrollPane();
        this.administrarSalonesPanel=administrarSalonesPanel;
    }
    ...
    private void initComponents() {
        ...
        barraBusqueda.setText("Ingrese el ID del salon");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        DefaultTableModel modelo=controlAdministrarSalones.obtenerModeloBusquedaSalon(itemBusqueda);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (tabla.getModel().getColumnClass(columna).equals(Object.class)) {
                    ...
                    if(btn.getActionCommand().equals("eliminar")){
                        int respuesta=JOptionPane.showConfirmDialog(null, "¿Eliminar este salon?", "Confirmar Eliminacion", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                        if(respuesta==0){
                            eliminarSalon(id,fila); 
                        }
                    }
                }
            }
    ...
    public void editarSalon(int idSalon){
        try {
        HashMap<String, String> campos=controlAdministrarSalones.obtenerDatosSalon(idSalon);
        EditarSalonPanel esp= new EditarSalonPanel();
        esp.llenarCampos(campos);
        administrarSalonesPanel.mostarPanel(esp);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    
    public void eliminarSalon(int idSalon,int fila){
        boolean eliminado=controlAdministrarSalones.eliminarSalon(idSalon);
        if(eliminado){
