 ...
 * @author ferchs
 */
public class AgregarExamenPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        nota.setForeground(new java.awt.Color(204, 204, 204));
        nota.setText("Ej: 4.5");
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if(validos){
            ...
            try{
               controlGestionarExamenes.crearExamen(idGrado, consecutivoTmp, idEstudiante, idMateria, temaTmp, fechaExamen, NotaTmp);
            JOptionPane mensaje= new JOptionPane();
            mensaje.setBackground(new java.awt.Color(102, 102, 102));
            mensaje.setForeground(Color.white);
            mensaje.showMessageDialog(null,"Se ha registrado un nuevo examen");
            limpiarCampos();
            }
            catch(Exception e){
                JOptionPane mensaje= new JOptionPane();
