 ...
 * @author ferchs
 */
public class BuscarMateriaPanel extends javax.swing.JPanel  {

    /**
     * Creates new form AgregarEstudiantePanel
     */
    
    protected GestionarMateriasPanel gestionarMateriasPanel;
    
    public BuscarMateriaPanel(GestionarMateriasPanel gestionarMateriasPanel) {
        initComponents();
        controlAdministrarMaterias= new ControlAdministrarRecursos();
        jScrollPane1= new JScrollPane();
        this.gestionarMateriasPanel=gestionarMateriasPanel;
    }
    ...
    private void initComponents() {
        ...
        barraBusqueda.setText("Ingrese el codigo de la materia");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        DefaultTableModel modelo=controlAdministrarMaterias.obtenerModeloBusquedaMateria(itemBusqueda);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (tabla.getModel().getColumnClass(columna).equals(Object.class)) {
                    ...
                    if(btn.getActionCommand().equals("eliminar")){
                        int respuesta=JOptionPane.showConfirmDialog(null, "¿Eliminar esta materia?", "Confirmar Eliminacion", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                        if(respuesta==0){
                            eliminarMateria(id,fila); 
                        }
                    }
                }
            }
    ...
    public void editarMateria(int codigo){
        try {
        HashMap<String, String> campos=controlAdministrarMaterias.obtenerDatosMateria(codigo);
        EditarMateriaPanel emp= new EditarMateriaPanel();
        emp.llenarCampos(campos);
        gestionarMateriasPanel.mostarPanel(emp);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    
    public void eliminarMateria(int codigo,int fila){
        boolean eliminado=controlAdministrarMaterias.eliminarMateria(codigo);
        if(eliminado){
