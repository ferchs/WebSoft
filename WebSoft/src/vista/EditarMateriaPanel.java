 ...
 * @author ferchs
 */
public class EditarMateriaPanel extends javax.swing.JPanel {
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if(validos){
            ...
            controlAdministrarMaterias.editarMateria(codigoTmp, nombreTmp);
    ...
    public void llenarCampos(HashMap<String, String> campos) throws ParseException{
        codigo.setText(campos.get("codigo"));
        nombre.setText(campos.get("nombre"));
    }
