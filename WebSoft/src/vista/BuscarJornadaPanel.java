 ...
 * @author ferchs
 */
public class BuscarJornadaPanel extends javax.swing.JPanel  {

    /**
     * Creates new form AgregarEstudiantePanel
     */
    
    protected GestionarJornadasPanel gestionarJornadasPanel;
    
    public BuscarJornadaPanel(GestionarJornadasPanel gestionarJornadasPanel) {
        initComponents();
        controlAdministrarRecursos= new ControlAdministrarRecursos();
        jScrollPane1= new JScrollPane();
        this.gestionarJornadasPanel=gestionarJornadasPanel;
    }
    ...
    private void initComponents() {
        ...
        barraBusqueda.setText("Ingrese el ID de la jornada");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        int itemBusqueda=Integer.parseInt(itemBusquedaStr);
        DefaultTableModel modelo=controlAdministrarRecursos.obtenerModeloBusquedaJornada(itemBusqueda);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (tabla.getModel().getColumnClass(columna).equals(Object.class)) {
                    ...
                    if(btn.getActionCommand().equals("eliminar")){
                        int respuesta=JOptionPane.showConfirmDialog(null, "¿Eliminar esta jornada?", "Confirmar Eliminacion", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                        if(respuesta==0){
                            eliminarJornada(id,fila); 
                        }
                    }
                }
            }
    ...
    public void editarJornada(int idJornada){
        try {
        HashMap<String, String> campos=controlAdministrarRecursos.obtenerDatosJornada(idJornada);
        EditarJornadaPanel ejp= new EditarJornadaPanel();
        ejp.llenarCampos(campos);
        gestionarJornadasPanel.mostarPanel(ejp);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    
    public void eliminarJornada(int idJornada,int fila){
        boolean eliminado=controlAdministrarRecursos.eliminarJornada(idJornada);
        if(eliminado){
    ...
    private ControlAdministrarRecursos controlAdministrarRecursos;
