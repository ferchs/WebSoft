...
import control.ControlAgregarProfesorPanel;
 ...
 * @author ferchs
 */
public class AgregarProfesorPanel extends javax.swing.JPanel {

    /**
     * Creates new form AgregarEstudiantePanel
     */
    public AgregarProfesorPanel() {
        controlAgregarProfesorPanel= new ControlAgregarProfesorPanel();
        initComponents();
    }
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if(validos){
            ...
            String direccionProfesorTmp=(String)direccionDocente.getText().trim();
            String barrioProfesorTmp=(String)barrioDocente.getText().trim();
            ...
            boolean exito=controlAgregarProfesorPanel.agregarProfesor(idProfesorTmp,tipoDocumentoProfesorTmp,
            ...
            if(exito){
                ...
                mensaje.showMessageDialog(null,"Se ha registrado un nuevo docente");
                limpiarCampos();
    ...
    private final void cargarPaises(){
        String [] listadoPaises=controlAgregarProfesorPanel.generarListadoPaises();
    ...
    private ControlAgregarProfesorPanel controlAgregarProfesorPanel;
