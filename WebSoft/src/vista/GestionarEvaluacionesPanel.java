 ...
 * @author ferchs
 */
public class GestionarEvaluacionesPanel extends javax.swing.JPanel {
     ...
     */
    public GestionarEvaluacionesPanel(CursosPanel cursosPanel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        agregarEvaluacion.setBackground(new java.awt.Color(102, 102, 102));
        agregarEvaluacion.setForeground(new java.awt.Color(255, 255, 255));
        agregarEvaluacion.setIcon(new javax.swing.ImageIcon("/Users/ferchs/Desktop/MasMini.png")); // NOI18N
        agregarEvaluacion.setBorderPainted(false);
        agregarEvaluacion.setOpaque(true);
        agregarEvaluacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregarEvaluacionActionPerformed(evt);
            }
        });
        PanelLogo1.add(agregarEvaluacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 60, -1));
        ...
        PanelLogo1.add(agregarCursoText, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, -1, -1));
    ...
    private void agregarEvaluacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarEvaluacionActionPerformed
        ...
        AgregarEvaluacionPanel agregarEvaluacionPanel=new AgregarEvaluacionPanel();
        mostarPanel(agregarEvaluacionPanel);
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        // TODO add your handling code here:
        BuscarEvaluacionPanel buscarEvaluacionPanel=new BuscarEvaluacionPanel(this);
        mostarPanel(buscarEvaluacionPanel);
