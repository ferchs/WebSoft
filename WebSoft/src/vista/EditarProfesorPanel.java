...
import control.ControlEditarProfesorPanel;
 ...
 * @author ferchs
 */
public class EditarProfesorPanel extends javax.swing.JPanel {

    /**
     * Creates new form AgregarEstudiantePanel
     */
    public EditarProfesorPanel() {
        controlEditarProfesorPanel= new ControlEditarProfesorPanel();
        initComponents();
    }
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if(validos){
            String idProfesorTmp=idDocente.getText().trim();
            String tipoDocumentoProfesorTmp=(String)tipoDocumentoDocente.getSelectedItem();
            String primerNombreProfesorTmp=primerNombreDocente.getText().trim();
            String segundoNombreProfesorTmp=segundoNombreDocente.getText().trim();
            String primerApellidoProfesorTmp=primerApellidoDocente.getText().trim();
            String segundoApellidoProfesorTmp=segundoApellidoDocente.getText().trim();
            String rhProfesorTmp=(String)rhDocente.getSelectedItem();
            String sexoProfesorTmp=(String)sexoDocente.getSelectedItem();
            Date fechaNacimientoTmp=fechaNacimiento.getDate();
            String estratoProfesorTmp=(String)estratoDocente.getSelectedItem();
            String paisProfesorTmp=(String)paisDocente.getSelectedItem();
            String lugarNacimientoProfesorTmp=(String)lugarNacimientoDocente.getText();
            String direccionProfesorTmp=(String)tituloDocente.getText().trim();
            String barrioProfesorTmp=(String)institucionDocente.getText().trim();
            String correoProfesorTmp=(String)correoDocente.getText().trim();
            String telefonoProfesorTmp=(String)telefonoDocente.getText().trim();
            String celularProfesorTmp=(String)celularDocente.getText().trim();
            String tipoSaludTmp=(String)tipoSalud.getSelectedItem();
            String nombreSaludProfesorTmp=(String)nombreSaludDocente.getText().trim();
            String tituloProfesorTmp=tituloDocente.getText().trim();
            String institucionProfesorTmp=institucionDocente.getText().trim();
            String nivelSisbenTmp="";
            if(nivelSisben.getSelectedIndex()>0){
                nivelSisbenTmp=(String)nivelSisben.getSelectedItem();
            }
            boolean exito=controlEditarProfesorPanel.editarProfesor(idProfesorTmp,tipoDocumentoProfesorTmp,
                    primerNombreProfesorTmp,segundoNombreProfesorTmp,primerApellidoProfesorTmp,
                    segundoApellidoProfesorTmp,rhProfesorTmp,sexoProfesorTmp,fechaNacimientoTmp,
                    estratoProfesorTmp,paisProfesorTmp,lugarNacimientoProfesorTmp,direccionProfesorTmp,barrioProfesorTmp,correoProfesorTmp,
                    telefonoProfesorTmp,celularProfesorTmp,tipoSaludTmp,nombreSaludProfesorTmp,tituloProfesorTmp,
                    institucionProfesorTmp,nivelSisbenTmp);
            if(exito){
    ...
    private void paisDocenteItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_paisDocenteItemStateChanged
        ...
        if(evt.getStateChange()==ItemEvent.SELECTED){
            if(paisDocente.getSelectedIndex()>0){
                lugarNacimientoDocente.setEnabled(true);
                lugarNacimientoDocente.setText("");
            }
            else{
                lugarNacimientoDocente.setEnabled(false);
                lugarNacimientoDocente.setText("Seleccione un Pais");
    ...
    private final void cargarPaises(){
        String [] listadoPaises=controlEditarProfesorPanel.generarListadoPaises();
        listadoPaises[0]="Seleccione...";
        DefaultComboBoxModel paises= new DefaultComboBoxModel(listadoPaises);
        paisDocente.setModel(paises);
    }
    
    private boolean validarCamposPanel( ){
        boolean datosCompletos=true;
      if(idDocente.getText().isEmpty()){
          idDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(tipoDocumentoDocente.getSelectedIndex()==0){
         tipoDocumentoDocenteT.setForeground(Color.red);
         datosCompletos=false;
      }
      if(primerNombreDocente.getText().isEmpty()){
          primerNombreDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(primerApellidoDocente.getText().isEmpty()){
          primerApellidoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(segundoApellidoDocente.getText().isEmpty()){
          segundoApellidoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(rhDocente.getSelectedIndex()==0){
          rhDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(sexoDocente.getSelectedIndex()==0){
          sexoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      ...
      if(estratoDocente.getSelectedIndex()==0){
          estratoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(paisDocente.getSelectedIndex()==0){
          paisDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(lugarNacimientoDocente.getText().isEmpty()){
          lugarNacimientoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(tituloDocente.getText().isEmpty()){
          tituloDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(institucionDocente.getText().isEmpty()){
          institucionDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(correoDocente.getText().isEmpty()){
          correoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(telefonoDocente.getText().isEmpty()){
          telefonoDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(celularDocente.getText().isEmpty()){
          celularDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
      if(nombreSaludDocente.getText().isEmpty()){
          nombreSaludDocenteT.setForeground(Color.red);
          datosCompletos=false;
      }
    ...
    private void limpiarCampos(){
        idDocente.setText("");
        idDocenteT.setForeground(Color.WHITE);
        tipoDocumentoDocente.setSelectedIndex(0);
        tipoDocumentoDocenteT.setForeground(Color.WHITE);
        primerNombreDocente.setText("");
        primerNombreDocenteT.setForeground(Color.WHITE);
        segundoNombreDocente.setText("");
        primerApellidoDocente.setText("");
        primerApellidoDocenteT.setForeground(Color.WHITE);
        segundoApellidoDocente.setText("");
        segundoApellidoDocenteT.setForeground(Color.WHITE);
        rhDocente.setSelectedIndex(0);
        rhDocenteT.setForeground(Color.WHITE);
        sexoDocente.setSelectedIndex(0);
        sexoDocenteT.setForeground(Color.WHITE);
        fechaNacimiento.setDate(null);
        fechaNacimientoT.setForeground(Color.WHITE);
        estratoDocente.setSelectedIndex(0);
        estratoDocenteT.setForeground(Color.WHITE);
        paisDocente.setSelectedIndex(0);
        paisDocenteT.setForeground(Color.WHITE);
        lugarNacimientoDocente.setText("");
        lugarNacimientoDocenteT.setForeground(Color.WHITE);
        tituloDocente.setText("");
        tituloDocenteT.setForeground(Color.WHITE);
        institucionDocente.setText("");
        institucionDocenteT.setForeground(Color.WHITE);
        direccionDocente.setText("");
        direccionDocenteT.setForeground(Color.WHITE);
        barrioDocente.setText("");
        barrioDocenteT.setForeground(Color.WHITE);
        correoDocente.setText("");
        correoDocenteT.setForeground(Color.WHITE);
        telefonoDocente.setText("");
        telefonoDocenteT.setForeground(Color.WHITE);
        celularDocente.setText("");
        celularDocenteT.setForeground(Color.WHITE);
        tipoSalud.setSelectedIndex(0);
        tipoSaludT.setForeground(Color.WHITE);
        nombreSaludDocente.setText("");
        nombreSaludDocenteT.setForeground(Color.WHITE);
    ...
    private ControlEditarProfesorPanel controlEditarProfesorPanel;
