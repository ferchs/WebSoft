 ...
 * @author ferchs
 */
public class AdministrarSalonesPanel extends javax.swing.JPanel {
     ...
     */
    public AdministrarSalonesPanel(RecursosPanel recursosPanel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        agregarSalon.setBackground(new java.awt.Color(102, 102, 102));
        agregarSalon.setForeground(new java.awt.Color(255, 255, 255));
        agregarSalon.setIcon(new javax.swing.ImageIcon("/Users/ferchs/Desktop/MasMini.png")); // NOI18N
        agregarSalon.setBorderPainted(false);
        agregarSalon.setOpaque(true);
        agregarSalon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregarSalonActionPerformed(evt);
            }
        });
        PanelLogo1.add(agregarSalon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 60, -1));
    ...
    private void agregarSalonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarSalonActionPerformed
        ...
        AgregarSalonPanel agregarSalonPanel=new AgregarSalonPanel();
        mostarPanel(agregarSalonPanel);
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        // TODO add your handling code here:
        BuscarSalonPanel buscarSalonPanel=new BuscarSalonPanel(this);
